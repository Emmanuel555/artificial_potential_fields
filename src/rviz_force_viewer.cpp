...
void forceCallback(const mavros_msgs::AttitudeTarget& msg){
    force << msg.body_rate.x, msg.body_rate.y, msg.body_rate.z;
}

void attractiveCallback(const mavros_msgs::AttitudeTarget& msg){
    attractive << msg.body_rate.x, msg.body_rate.y, msg.body_rate.z;
}
...
int main( int argc, char** argv ){
  ...
  ros::Subscriber force_publisher = node_handle.subscribe("/mavros/setpoint_raw/attitude", 1, forceCallback);
